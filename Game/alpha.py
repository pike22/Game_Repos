...
class Alpha():
	...
	def __init__(self):
		...
		#from level Designer
		self.__GUI	= GUI_Main(self.__cLogic, self.__iNode, self.__kNode, self.__cNode, self.__mainApp, color=None, mainMenu=None)
	...
	def tk_windowSETUP(self):
		"""
		Sets up basic information of the tkinter window.
		"""
	...
	def set_MainCanvas(self): #Set Renders HERE
		"""
		Sets up the main canvas for the actuall game space.
		"""
