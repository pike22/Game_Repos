#here will be the "Storage" container for entityName's information.

class entityName_Info():
	def __init__(self):
		#engine based Parameters.
		self.__file_Location = None
		self.__Speed 		 = None
		self.__Canvas_ID	= None
		self.__group_ID		= '#entityName'
		self.__ID			= ''
	...
	def entityName_Data(self, Coords=None, Speed=None, health=None, defense=None, attack=None): #add more here as needed.
	...
	def get_Speed(self):
		return self.__entityName_Speed
